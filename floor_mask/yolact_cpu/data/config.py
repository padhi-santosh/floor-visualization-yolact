import sys
sys.path.append("../django_yolact/floor_mask/yolact_cpu/")
...
dataset_base = Config({
    ...
    'train_images': '/content/drive/MyDrive/yolact/data/floor_dataset/train/images/',
    'train_info':   '/content/drive/MyDrive/yolact/data/floor_dataset/train/coco_annotations.json',

    # Validation images and annotations.
    'valid_images': '/content/drive/MyDrive/yolact/data/floor_dataset/val/images/',
    'valid_info':   '/content/drive/MyDrive/yolact/data/floor_dataset/val/coco_annotations.json',
...
yolact_resnet50_pascal_config = yolact_resnet50_config.copy({
    'name': "yolact_plus_resnet50_floor", # Will default to yolact_resnet50_pascal
